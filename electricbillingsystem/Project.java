...
String atype, meter;
    Project(String atype,String meter) {
        ...
        updateinformation.setFont(new Font("monospaced",Font.BOLD,12));
        ...
        viewinformation.setFont(new Font("monospaced",Font.BOLD,12));
        ...
        JMenuItem generatebill = new JMenuItem("Genertae Bill");
        ...
        exits.setFont(new Font("monospaced",Font.BOLD,12));
        ...
        exits.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_E,ActionEvent.CTRL_MASK));
        exit.add(exits);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(msg.equals("New Customer")) {
            ...
            new PayBill(meter);
        }else if (msg.equals("Genertae Bill")) {
